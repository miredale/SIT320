...
namespace observer
{
    ...
    class ConcreteSubscriberA : Subscriber
    {
        ...
        {            
            Console.WriteLine("Mobile Device (display): " + (subject as Publisher).Wickets + "/" + (subject as Publisher).lbw + "/" + (subject as Publisher).Score);
        }
    }
    ...
    class ConcreteSubscriberB : Subscriber
    {
        public void Update(IPublisher subject)
        {
            Console.WriteLine("Laptop Device (display): " + (subject as Publisher).Wickets + "/" + (subject as Publisher).lbw + "/" + (subject as Publisher).Score);
        }
    }
    ...
    public class Publisher : IPublisher
    {
        ...
        public void legBeforeWicket()
        {
            Thread.Sleep(10000);

            this.lbw += 1;

            Console.WriteLine("Subject: Wicket Fallen: " + this.lbw);
            this.Notify();
        }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /* Game has started */
            publisher.scoreIncrease(0);
            publisher.legBeforeWicket();
